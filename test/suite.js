...
!function() {
	...
	describe('jquery.finger', function() {
      ...
      fixtures.parentNode.replaceChild(fixtures.cloneNode(true), fixtures);

      this.el = document.querySelector('.touchme');
      ...
      //
        ...
        this.el.addEventListener('tap', handler);
        simulate(this.el, 'tap', {}, function() {
          handler.should.have.been.calledOnce;
          handler.should.have.been.calledOn(el);
        }, done);
			});
  ...
  function simulate(el, gesture, options, assertions, done) {
    Simulator.gestures[gesture](el, options, function() {
      var err;
